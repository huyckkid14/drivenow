...
- Each C entry or exit swings the driver door outward first, animates the pedestrian stepping through the doorway with moving legs, and closes only after the body clears the door.
